...
namespace rbcpy
{
    ...
    public static class FilenameUtils
    {
            ...
            out string pathWithoutCategory, out string category)
        {
            ...
            {
                throw new RbCpyException("Directories should not have marker");
            }

            var parts = Utils.SplitByString(pathAndCategory, MarkerString);
            if (parts.Length != 2)
            {
                throw new RbCpyException("Path " + pathAndCategory +
    ...
    public sealed class RbCpyException : Exception
    {
        ...
        public RbCpyException(string message)
            : this(message, null)
        {
        }

        public RbCpyException()
            : this("", null)
        {
        }
