            ...
            if bNoModifierKeys:
                if event.keycode not in self.keyCodesCurrentlyHeld:
                    ...
                    self.keyCodesCurrentlyHeld[
                        event.keycode
                    ] = notenumber, startTime #(need to record notenumber because transposition may have changed)

            else:
                self.keyCodesCurrentlyHeld[
                    event.keycode] = -1 #means that this note was played with a modifier key.
