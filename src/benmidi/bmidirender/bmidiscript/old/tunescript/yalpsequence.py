...
def gowhile(strt, chars):
    #eat a string until you get something not in chars. Returns the rest, too.
...
def CreateNote(strn, env):
    ...
    if strn == '':
        return -1
    elif gowhile(strn, '0123456789:')[1] == '':
        return -1 #Don't accept a string of all numbers
